...
/**
 * Interface available for Cassandra cluster. Currently we don't have any other possibilities
 * of data retrieval. To change behavior requires change in production cluster, which requires
 * a lot of testing upfront.
 *
